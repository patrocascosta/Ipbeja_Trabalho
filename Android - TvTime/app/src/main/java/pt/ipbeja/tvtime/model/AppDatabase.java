            ...
            INSTANCE = Room.databaseBuilder(
                    ...
                    .addCallback(new Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            super.onCreate(db);
                            //Meter codigo sql
                            db.execSQL("INSERT INTO Serie(nomeSerie, idCategoria, Imdb, descricao, imagem) " +
                            ...
                            db.execSQL("INSERT INTO User(userId, password, email, nacionalidade)"+ "VALUES(1,'123','123','123')");
                            db.execSQL("INSERT INTO User(password, email, nacionalidade)"+ "VALUES('teste','123','Potuguesa')");
